...
[Add extra claims to an Azure B2C user flow using API connectors](https://damienbod.com/2021/11/15/add-extra-claims-to-an-azure-b2c-user-flow-using-api-connectors/)
